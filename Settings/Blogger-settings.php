<div class="tab-pane <?php echo ( $active_tab == "blogger") ? "active" : '' ?>" id="blogger">
	<form id="blogger-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
        ...
        <div class="box box-primary">
            <div class="box-header sap-settings-box-header"><?php echo $sap_common->lang('blogger_api_setting'); ?></div>
            ...
            <div id="facebook-app-method">
                ...
                if ( empty( $blogger_app_accounts ) ) {
                    echo '<p><a class="sap-grant-fb-android btn btn-primary" href="'. $blogger->sap_auto_poster_get_blogger_login_url() .'"> '.$sap_common->lang("blogger_add_account").' </a></p>';
                }
